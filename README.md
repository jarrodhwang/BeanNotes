...
- PencilKit drawing with custom palettes, focus drawing mode, editor touch-mode switching, undo and redo, live zoom/ink calibration, zoom-friendly rendering, and local autosave.
