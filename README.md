...
- PencilKit drawing with custom palettes, remembered palette placement, focus drawing mode, editor touch-mode switching, undo and redo, sub-point Light Touch ink, live zoom/ink calibration, Ultra Fine zoom presets, zoom-friendly rendering, and local autosave.
