...
- PencilKit drawing with custom palettes, remembered palette placement, focus drawing mode with compact undo/redo/zoom controls, editor touch-mode switching, sub-point Light Touch ink, one-tap Detail Writing Mode, Light Touch Focus, live zoom/ink calibration, Ultra Fine zoom presets, zoom-friendly rendering, and local autosave.
